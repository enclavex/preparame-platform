<template>
  <q-card class="home-company-labor-risk-card column q-pb-md q-px-md q-ma-md">
    <div class="home-company-labor-risk-card-header row">
      <q-icon
        name="mdi-account-multiple-remove-outline"
        class="text-h1 text-grey-4 text-weight-thin q-ml-md col-4"
      ></q-icon>
      <div class="home-company-labor-risk-card-info-container col-6">
    ...
    <q-card-section class="home-company-labor-risk-card-bar-container row">
      <div class="home-company-labor-risk-card-progress-bar-container col-12">
        <div
          class="home-company-labor-risk-card-progress-bar-indicator"
          :style="{
            width: `${laborRiskPercent}%`,
          }"
        ></div>
      </div>
    </q-card-section>
